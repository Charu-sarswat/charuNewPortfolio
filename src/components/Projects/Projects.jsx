  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.div 
            className="flex flex-nowrap md:flex-wrap justify-start md:justify-center gap-3 md:gap-4 pb-4 md:pb-0 px-4 md:px-0 min-w-full"
            variants={containerVariants}
            initial="hidden"
            animate="visible"
          >
            {categories.map((category, index) => (
              <motion.button
                ...
                className={`relative whitespace-nowrap px-4 md:px-6 py-2 md:py-3 text-sm md:text-base rounded-full 
